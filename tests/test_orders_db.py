...
# IMPORTANT: Ensure 'small-shop-ecommerce-firebase-adminsdk-fbsvc-aeb7d43f71.json'
# is in the root of your project or accessible via the specified path.
SERVICE_ACCOUNT_KEY_PATH = "small-shop-ecommerce-firebase-adminsdk-fbsvc-aeb7d43f71.json"
